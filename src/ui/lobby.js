export function createLobbyScreen(container, onStartGame) {
    ...
    <div class="lobby">
      <div class="lobby-card">
        ...
        <div class="lobby-header">
          <h1>The Duel</h1>
          <p class="lobby-subtitle">Sharia-Compliant Investing Battle</p>
        </div>
        <div class="lobby-divider"><span></span></div>
        ...
        <div class="lobby-footer">4 Quarters &bull; 6 Assets &bull; Purify Your Returns</div>
      </div>
  ...
  function showStatus(msg, isError) {
    statusEl.textContent = msg; statusEl.className = 'lobby-status' + (isError ? ' error' : ''); statusEl.classList.remove('hidden')
  }
  nameInput.focus()
}
