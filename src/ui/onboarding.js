  ...
  const steps = [
    {
      ...
      desc: 'Compete against an AI opponent to build the best Sharia-compliant portfolio over 4 quarters. Allocate your capital, balance return vs purity, and outsmart your rival.',
    },
    {
      title: 'Making Allocations',
      desc: 'Drag sliders to distribute your capital across assets. Watch the purity scores — high-return assets may carry more impurity. Cash is risk-free but returns less.',
    },
    {
      title: 'Scoring',
      desc: 'Your score = portfolio return × (1 − portfolio impurity). Market events will test your strategy. Highest adjusted return after 4 quarters wins.',
    }
  ]
